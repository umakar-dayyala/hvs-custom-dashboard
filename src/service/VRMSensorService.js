...
const API_BASE_URL = `${process.env.REACT_APP_API_PROTOCOL}://${process.env.REACT_APP_API_IP}:${process.env.REACT_APP_API_PORT}/api/vrm`

export const fetchVRMParamChartData = async (deviceId, fromTime, toTime) => {
  try {
